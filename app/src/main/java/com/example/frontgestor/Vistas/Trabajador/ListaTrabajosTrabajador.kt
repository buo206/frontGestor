...
@Composable
fun ListaTrabajosTrabajador(modifier: Modifier = Modifier ,
    ...
    val trabajosFiltrados = trabajadorViewModel.trabajos?.filter {
        it.titulo?.contains(textoBusqueda, ignoreCase = true) == true
    }

    LaunchedEffect(Unit){
        trabajadorViewModel.listarTrabajos(sesion.getUserId())
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                placeholder = { Text("Buscar trabajo ...") },
                leadingIcon = {
            ...
            if(trabajadorViewModel.trabajos == null){
                Box(
                        ...
                        if(trabajo.estado != "F" ){
                            Card(
                                ...
                                onClick = {
                                    ...
                                    trabajadorViewModel.buscarTrabajo(trabajo.idTrabajo)
                                    trabajadorViewModel.limpiarListaMateriales()
                                    onDetalle()
                                }
                            ) {
